...
//Найти все четверки точек, являющихся вершинами квадратов.
...
const int MAX = 7;
Point a[MAX] = {{-1,1},{1,1},{1,-1},{-1,-1},{-5,6},{-100,3},{0,0}};
